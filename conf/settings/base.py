...
env.read_env(str(APPS_DIR / "conf" / ".env" / ".django"))
env.read_env(str(APPS_DIR / "conf" / ".env" / ".postgresql"))
...
INSTALLED_APPS = DJANGO_APPS + THIRD_PARTY_APPS + HEALTH_CHECKS + LOCAL_APPS
